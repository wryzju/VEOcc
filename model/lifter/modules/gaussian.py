...
def draw_heatmap_gaussian(heatmap, center, radius, k=1):
    ...
    masked_gaussian = torch.from_numpy(gaussian[radius - top:radius + bottom,
...
def generate_guassian_depth_target(depth, stride, cam_depth_range, constant_std=None):
    ...
    x = torch.arange(cam_depth_range[0] - cam_depth_range[2] / 2, cam_depth_range[1], cam_depth_range[2]).float()
    x = x / cam_depth_range[2]
