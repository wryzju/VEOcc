...
class Global_Geo_Scal_Loss(BaseLoss):
    ...
    def __init__(self, weight=1.0, ignore_label=255, empty_idx=None, input_dict=None, **kwargs):
        super().__init__(weight)

        if input_dict is None:
            self.input_dict = {'pred': 'ce_input', 'ssc_target': 'ce_label'}
        else:
...
class Global_Sem_Scal_Loss(BaseLoss):
    ...
    def __init__(self, weight=1.0, ignore_label=255, sem_cls_range=None, input_dict=None, **kwargs):
        super().__init__(weight)
...
class Geo_Scal_Loss(BaseLoss):
    ...
    def geo_scal_loss(self, pred, ssc_target, fov_mask):
        ...
        mask = ((ssc_target != self.ignore_label).squeeze(0)) & fov_mask
        if len(mask.shape) == 3:
