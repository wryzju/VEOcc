...
load_from = 'workdir/train_mono_full_final/epoch_10.pth'
loss = dict(
    loss_cfgs=[
        dict(
            alpha=0.25,
...
train_loader_config = dict(batch_size=2, num_workers=8, shuffle=True)
...
val_dataset_config = dict(
    ...
    phase='test',
    type='Scannet_Online_SceneOcc_Dataset')
val_loader_config = dict(batch_size=2, num_workers=8, shuffle=False)
val_wrapper_config = dict(
    ...
    type='Scannet_Scene_Occ_DatasetWrapper')
voxel_size = 0.08
work_dir = 'workdir/train_embodied_full'
